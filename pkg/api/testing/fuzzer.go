...
func FuzzerFor(t *testing.T, version string, src rand.Source) *fuzz.Fuzzer {
	...
	f.Funcs(
		...
		func(vs *api.VolumeSource, c fuzz.Continue) {
			...
			fuzzOneOf(c, &vs.HostPath, &vs.EmptyDir, &vs.GCEPersistentDisk, &vs.AWSElasticBlockStore, &vs.GitRepo, &vs.Secret, &vs.NFS, &vs.ISCSI, &vs.Glusterfs, &vs.CinderPersistentDisk)
		},
